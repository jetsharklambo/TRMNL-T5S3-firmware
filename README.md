...
2. **Put device in bootloader mode**
   ...
   **Two methods to enter bootloader mode:**

   **Method A (Recommended)**: Hold BOOT while plugging in
   - Press and hold the **BOOT** button
   - While holding BOOT, plug in the USB-C cable
   - Release the **BOOT** button
   - Device is now in bootloader mode (ready to flash)

   **Method B**: Using BOOT + RESET buttons
...
- **TRMNL Team** - Excellent IoT platform: [usetrmnl.com](https://usetrmnl.com)
- **Larry Bank** - FastEPD library author: [github.com/bitbank2/FastEPD](https://github.com/bitbank2/FastEPD)
- **LilyGo** - T5S3 Pro hardware: [github.com/Xinyuan-LilyGO/T5S3-4.7-e-paper-PRO](https://github.com/Xinyuan-LilyGO/T5S3-4.7-e-paper-PRO)
- **Espressif Systems** - ESP32 Arduino Framework
